...
-   [FCCDIRAC](#fccdirac)
    ...
    -   [Prerequisites](#prerequisites)
        -   [1- GRID access](#grid)
        -   [2- Setting up ILCDIRAC environment](#dirac)
...
That's the prurpose of the creation of the WLCG (Worlwide LHC Computing Grid) which is a global collaboration of more than 170 computing centres in 42 countries, 
...
#importations of fcc core classes needed to submit a job
...
#finally, we submit the 1st fcc job containing 2 applications in this case
fcc.submit()
